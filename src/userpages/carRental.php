...
<!--Display car data-->
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo '
            ...
            <div class="whiteBoxImage">
            <form method="post" action="../adminpages/uploadUser.php" enctype="multipart/form-data">
            ...
            <div class="carUserDataBox">
                ...
                <input type="email" id="kenteken" name="addEmail"><br>
            </div>
            ...
            <div class="carUserDataBox">
                ...
                <input type="text" id="kenteken" name="addName"><br>
            </div>
            ...
            <div class="carUserDataBox">
                ...
                <input type="text" id="kenteken" name="addMiddlename"><br>
            </div>
            ...
            <div class="carUserDataBox">
                ...
                <input type="text" id="kenteken" name="addLastname"><br>
            </div>
            ...
            <div class="carUserDataBox">
                ...
                <input type="date" id="kenteken" name="addBirthdate"><br>
            </div>
            ...
            <div class="carUserDataBox">
                ...
                <input type="text" id="kenteken" name="addPlace"><br>
            </div>
                    
            <div class="carUserDataBox">
                <label for="addKenteken">Straat</label><br>
                <input type="text" id="kenteken" name="addStreet"><br>
            </div>
            ...
            <div class="carUserDataBox">
                ...
                <input type="text" id="kenteken" name="addPostalcode"><br>
            </div>
